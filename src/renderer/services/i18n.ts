...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    copilotAuthTitle: 'GitHub Copilot 认证',
    copilotSignedIn: '已登录',
    copilotSignOut: '退出登录',
    copilotSignInWithGitHub: '使用 GitHub 登录',
    copilotSigningIn: '登录中...',
    copilotSignInDescription: '使用您的 GitHub 账号登录，需要具有 Copilot 订阅',
    copilotSignInFailed: '登录失败',
    copilotDeviceFlowInstructions: '请在浏览器中打开以下链接并输入验证码：',
    copilotCopyCode: '复制',
    copilotWaitingForAuth: '等待授权...',
    copilotRequiresSubscription: '需要 GitHub Copilot 订阅（Individual、Business 或 Enterprise）',
    copilotNotSignedIn: '请先登录 GitHub Copilot',
    copilotTokenFetchFailed: '获取 Copilot Token 失败',
  },
  en: {
    // Common
    save: 'Save',
    ...
    copilotAuthTitle: 'GitHub Copilot Authentication',
    copilotSignedIn: 'Signed in',
    copilotSignOut: 'Sign out',
    copilotSignInWithGitHub: 'Sign in with GitHub',
    copilotSigningIn: 'Signing in...',
    copilotSignInDescription: 'Sign in with your GitHub account. Requires an active Copilot subscription.',
    copilotSignInFailed: 'Sign in failed',
    copilotDeviceFlowInstructions: 'Open the following link in your browser and enter the code:',
    copilotCopyCode: 'Copy',
    copilotWaitingForAuth: 'Waiting for authorization...',
    copilotRequiresSubscription: 'Requires a GitHub Copilot subscription (Individual, Business, or Enterprise)',
    copilotNotSignedIn: 'Please sign in to GitHub Copilot first',
    copilotTokenFetchFailed: 'Failed to get Copilot token',
  }
};
